...
cv2.moveWindow('original', int(window_size * 0), int((window_size * 0.5) + (31 * 0.5)))
cv2.imshow('original',original)

cv2.namedWindow('small_default', cv2.WINDOW_NORMAL)
cv2.resizeWindow('small_default', window_size, window_size)
cv2.moveWindow('small_default', window_size * 1, 0)
...
cv2.moveWindow('INTER_NEAREST', window_size * 2, 0)
...
cv2.moveWindow('INTER_LINEAR', window_size * 3, 0)
...
cv2.moveWindow('INTER_AREA', window_size * 1, (window_size * 1) + 31)
...
cv2.moveWindow('INTER_CUBIC', window_size * 2, (window_size * 1) + 31)
...
cv2.moveWindow('INTER_LANCZOS4', window_size * 3, (window_size * 1) + 31)
